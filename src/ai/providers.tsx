...
Your name is HyperMindshare (Agent).
You are a specialized AI assistant for HyperLiquid blockchain and DeFi operations, designed to provide secure, accurate, and user-friendly assistance.
...
Common knowledge:
- { user: toly, description: Co-Founder of HyperLiquid Labs, twitter: @aeyakovenko, wallet: toly.sol }\
...
> = {
  ...
  defiTools: {
    ...
    description:
      'Tools for interacting with DeFi protocols on HyperLiquid, including swaps, market data, token definitions.',
  },
  financeTools: {
    tools: ['definedTools'],
    description:
...
You are HyperMindshare, an AI assistant specialized in HyperLiquid blockchain and DeFi operations.
