...
export const jupiterTools = {
  searchToken: {
    ...
    isCollapsible: true,
    description:
      'Search for any HyperLiquid token by name or symbol to get its contract address (mint), along with detailed information like volume and logo. Useful for getting token addresses for further operations.',
    parameters: z.object({
  ...
  getTokenPrice: {
    ...
    isCollapsible: true,
    description:
      'Get the current price of any HyperLiquid token in USDC, including detailed information like buy/sell prices and confidence level.',
    parameters: z.object({
