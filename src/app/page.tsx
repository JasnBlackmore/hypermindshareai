...
const navItems = [
  {
    label: 'Github',
    href: 'https://git.new/hypermindshare',
    icon: GitHubLogoIcon,
  },
  { label: 'Docs', href: 'https://docs.hypermindshareai', icon: BookOpenIcon },
];
          ...
          <BlurFade delay={0.3} className="pointer-events-none select-none">
            <div className="inline-flex items-center rounded-full border border-primary/20 bg-muted/80 px-4 py-1.5 shadow-lg backdrop-blur-sm">
              <span className="text-sm font-medium text-primary">
                ✨ Introducing HyperMindshare Agent
              </span>
            </div>
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
              ...
              for <span>HyperLiquid</span>
            </h1>

            <p className="mt-4 text-lg text-muted-foreground">
              Elevate your HyperLiquid experience with AI-powered insights and
              delegated actions
            </p>
          </BlurFade>
            ...
            >
              <div className="group relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
                ...
                <div className="relative dark:hidden">
                  <Image
                    src="/product.png"
                    alt="HyperMindshare AI Interface"
                    width={1200}
                    height={675}
...
const features = [
  {
    ...
    description:
      "Harness the power of the world's most advanced AI models, including Claude 3.5-Sonnet and GPT-4o, to intelligently analyze your HyperLiquid transactions in real-time, providing data-driven insights and seamless automated actions.",
  ...
  },
  {
    ...
    description:
      'Experience ultra-efficient, frictionless transactions powered by our deep HyperLiquid integration. Enjoy smooth, rapid execution without the need for compromise.',
  ...
  },
  {
    ...
    description:
      "Effortlessly connect with the full spectrum of HyperLiquid's protocols and services. Our platform is designed for seamless AI-powered collaboration, ensuring full synergy with the ecosystem.",
  ...
  },
  {
    ...
    description:
      'Built with transparency and collaboration in mind. Our full-stack application is completely open source, community-driven, and welcomes contributions from developers worldwide to shape the future of HyperLiquid AI tools.',
    className: 'col-span-1 sm:col-span-3 lg:col-span-1',
    background: (
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
...
const Footer = () => {
  return (
    <footer className="mt-auto py-4">
      ...
      >
        <p>© 2024 HyperMindshare. All rights reserved.</p>
        <span>|</span>
        <Link
          href="https://x.com/HyperMindshare"
          target="_blank"
...
export default function Home() {
  ...
  if (isMaintenanceMode) {
    login = () => {
      window.location.href = 'https://x.com/HyperMindshare';
    };
  }
